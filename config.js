...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || "94743666984"  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://salmanahmad:s4salmanyt@cluster0.szcj2eo.mongodb.net/?retryWrites=true&w=majority"
global.port= process.env.PORT || 5000
global.email = 'xheikhsalman4422@gmail.com'
global.github = 'https://github.com/salmanytofficial/XLICON-MD'
global.location = 'Sri Lanaka'
global.gurl = 'https://instagram.com/itz_shaikho/' // add your username
global.sudo = process.env.SUDO || '218914807168' 
global.devs = '94743666984';
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || 'Mr.sene',
   
  botname:   process.env.BOT_NAME === undefined ? "Senesh" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Mr.Sene' : process.env.OWNER_NAME,  
